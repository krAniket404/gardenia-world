...
const intro = [
  {
    ...
    description: [
      "At Gardenia World School, we believe that education is not just about academics, but about holistic development. Our school is a place where students from Play Group to class 5 learn, grow, and thrive in a nurturing environment.",
