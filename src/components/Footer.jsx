...
const Footer = () => {
  return (
    <div className="bg-[url('./assets/footer-bg.jpg')] bg-cover z-0 bg-center after:-z-10 after:absolute relative after:top-0 after:left-0 after:h-full after:w-full after:bg-gray/80 text-white p-16">
